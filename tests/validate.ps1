...
$checks = [ordered]@{
    ...
    'MySQL user passwords stay out of previews' = $bash.Contains('password hidden') -and $powershell.Contains('password hidden') -and $bash.Contains('read_hidden_paste_input "New user password (minimum 12 characters):"') -and $powershell.Contains("Read-HiddenPasteInput 'New user password (minimum 12 characters):'")
